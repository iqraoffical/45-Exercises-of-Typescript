...
let new_Users = ["Maira", "Bilal", "Iqra", "Areeba", "Jamal"];
...
// let currentUsers: string[] = ['Iqra', 'Salman', 'Bilal', 'Bismillaha', 'Fatima'];
// let newUsers: string[] = ['Aliza', 'Bilal', 'Iqra', 'Areeba', 'Jamal'];
// // Convert currentUsers to lowercase for case-insensitive comparison
